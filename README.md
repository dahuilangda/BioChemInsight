...
```bash
# MolNexTR + MoE weights from HuggingFace (Docker build does this automatically)
...
# DECIMER segmentation weights (Zenodo, manual install only; Docker build does this automatically)
